...
function Settings({ data, updateData, accessToken, demo, onSignOut, onAccountDeleted, onNotice }: { data: FinanceData; updateData: (updater: (current: FinanceData) => FinanceData) => void; accessToken?: string; demo: boolean; onSignOut: () => void; onAccountDeleted: () => void; onNotice: (message: string) => void }) {
  ...
  async function deleteAccount() {
    ...
    try {
      ...
      onNotice(error instanceof Error ? error.message : "Não foi possível excluir sua conta.");
      setDeleting(false);
    }
  }
